...
import type { ApiKey } from "../../types/domain/ApiKey";
...
export const apiKey = {
  ...
  /**
   * Delete an API key outright, revoked or not: it stops authenticating at
   ...
   */
  delete: Tapi.delete<{ path: { api_key_uid: Uid }; response: null }>()({
